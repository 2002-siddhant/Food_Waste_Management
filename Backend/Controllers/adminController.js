...
exports.getReports = async (req, res) => {
    try {
        const [quantityByType, donationsByCategory, topDonors, topNgos, deliveryStatusCounts] = await Promise.all([
            Donation.aggregate([
        ...
        res.json({ quantityByType, donationsByCategory, topDonors, topNgos, deliveryStatusCounts });
    } catch (error) {
        console.error(error);
